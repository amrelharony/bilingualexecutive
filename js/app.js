...
copyToClipboard(text, label = "Content") {
    ...
    if (this.deferredPrompt) {
        try {
            ...
            if (outcome === 'accepted') {
                _toast('App installed successfully!', 'success');
            }
...
_showInstallInstructions() {
    this._pwaInstructionsVisible = true;
},

_dismissInstallInstructions() {
    this._pwaInstructionsVisible = false;
    this.dismissPwa();
},
