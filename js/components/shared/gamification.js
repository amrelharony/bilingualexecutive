    ...
    Alpine.store('gamification', {
        ...
        async pushToSupabase() {
            ...
            try {
                ...
                if (error) { window._handleDbError?.(error); return; }
                if (data) {
                    this.supabaseId = data.user_id;
                    this.dirty = false;
                }
            } catch (e) { window._handleDbError?.(e); }
        },
    ...
    Alpine.data('gamificationProfile', () => ({
        ...
        renderSkillChart() {
            this.$nextTick(() => {
                ...
                const pointR = isMobile ? 3 : 4;

                this.chartInstance = new Chart(canvas, {
                    type: 'radar',
                    data: {
                        labels: isMobile
                            ? ['Strategic', 'Technical', 'Battle', 'Knowledge']
                            : ['Strategic Vision', 'Technical Mastery', 'Battle Readiness', 'Knowledge Capital'],
                        datasets: [{
                            label: 'Competency',
                    ...
                    options: {
                        ...
                        scales: {
                            r: {
                                ...
                                pointLabels: {
                                    color: labelColor,
                                    font: { size: labelFont, family: 'Inter', weight: isLight ? '600' : '400' },
                                },
                            },
                        },
                        plugins: {
